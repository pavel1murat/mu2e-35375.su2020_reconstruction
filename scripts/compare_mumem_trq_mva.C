...
TGraph* gr_dar_cele0s51b1_1070(nullptr);
TGraph* gr_dar_cele0s51b1_0170(nullptr);
//-----------------------------------------------------------------------------
...
// Index: 0:PAR, 1:DAR
//-----------------------------------------------------------------------------
int make_mumem_performance_plot(const char* HistDir, const char* SigDsID, const char* BgrDsID, int MVATrainingCode, int Index, TGraph** Graph) {

  TString fn_dio = Form("%s/su2020/su2020.%s.track_comp_use_mva_ffff_%04i.hist",HistDir,BgrDsID,MVATrainingCode);
  TString fn_sig = Form("%s/su2020/su2020.%s.track_comp_use_mva_ffff_%04i.hist",HistDir,SigDsID,MVATrainingCode);
...
void compare_mumem_mva() {
  ...
  make_mumem_performance_plot(HistDir, "cele0s51b1", "fele2s51b1", 1070, index, &gr_dar_cele0s51b1_1070);
  make_mumem_performance_plot(HistDir, "cele0s61b1", "fele2s51b1",  170, index, &gr_dar_cele0s51b1_0170);
  ...
  gr_dar_cele0s51b1_1070->SetMarkerStyle(20);
  gr_dar_cele0s51b1_1070->Draw("alp");
  gr_dar_cele0s51b1_1070->GetXaxis()->SetRangeUser(0.1,1.1);
  gr_dar_cele0s51b1_1070->GetYaxis()->SetRangeUser(0.1,2.1);
  
  gr_dar_cele0s51b1_0170->SetMarkerStyle(20);
  gr_dar_cele0s51b1_0170->SetLineColor  (kRed+2);
  gr_dar_cele0s51b1_0170->SetMarkerColor(kRed+2);
  gr_dar_cele0s51b1_0170->Draw("lp,same");
