...
\begin{titlepage}
 ...
 \end{flushright}
  ...
  \begin{center}
    ...
    G.De Felice (Univ of Pisa), S. Di Falco (INFN Pisa), M. Hedges (Purdue), S. Huang (Purdue),
  ...
  \begin{abstract}
    The note documents MC datasets used for Mu2e '2020 sensitivity update (SU2020)
  \end{abstract}
