...
\caption{
  ...
  {\blue Default Offline} PAR track selection {\blue uses} $S_{PAR} > 0.8$; {\blue (SDF) I would put also the PAR cut in the text body}  \strike{DAR track selection: $S_{DAR} > 0.2$}
